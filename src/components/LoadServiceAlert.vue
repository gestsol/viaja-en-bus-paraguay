<template>
  <notifications group="stuck-load"
    :duration="-1"
    ...
    <template slot="body" slot-scope="props">
      <div class="custom-template font">
        <div class="custom-template-icon">
          <v-progress-circular indeterminate :size="40" color="light"></v-progress-circular>
        </div>
        ...
        <div class="custom-template-close displayNoneTiny"
             @click="props.close">
