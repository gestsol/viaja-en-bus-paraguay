let en = () => {
  return {
    ...
    cancellations_error: 'An error occurred while canceling a ticket, please try again later',
    ...
    faq_title7: 'If I want to cancel my ticket and opt for a change in the itinerary or for a return, what aspects should I take into account?',
    faq_title8: 'What do I do if my bus is canceled?',
    faq_title9: 'What should I do if my purchase confirmation does not arrive and I have already debited the payment in my account?',
    faq_title10: 'What happens if I don\'t arrive at the departure time?',
    faq_title11: 'How is the refund of money in case of return?',
    faq_document1: 'It is the first platform for the sale of land tickets endorsed by the National Bus Federation (FENABUS).',
    faq_document2: 'ViajeenBus.cl gives you the different options of all the associated companies, according to destination, provider, dates and availability of seats. Select all the availabilities of the different companies, capturing it on a single website for the convenience of the users. You can pay directly using the existing payment mechanisms.',
    faq_document3_1: 'You can register on our site, to have purchase history or do it directly',
    faq_document3_2: 'Select your origin, destination and date, then you can receive all the options according to availability from the service providers.',
    faq_document3_3: 'Check all the available options according to company, date, destination and seats.',
    faq_document3_4: 'Enter the passenger information, which must be duly filled in as it is non-transferable.',
    faq_document3_5: 'Make the payment using the existing options, and wait for the payment confirmation, only at that moment will you be sure of the purchase of your ticket. If you do not receive the confirmation, you must call our After Sales team.',
    ...
    faq_document9: 'Unfortunately, it cannot be considered a total or partial refund of the ticket price.',
    faq_document10: 'Through bank account deposit. If you comply with the return conditions, you must register the bank details in the request through the platform in the "Return ticket" option or send an email with the return bank details, registered mail and reservation code. The return may take up to 8 business days depending on the entities and the means of payment.',
    payment_document: 'In Viajarenbus.cl it\'s possible buy tickets by WebPay Plus, a payment method supported by Transbank, which has links to different national and international bank cards.',
    about_title1: 'MISSION',
    about_title2: 'VIEW',
    about_title3: 'VALUES',
    about_document1: 'Convert the Travel by Bus platform into the reference par excellence in the sale of online land tickets throughout Chile.',
    about_document2: 'To be the fastest, most effective and easiest platform to use, with users who feel safe and supported by Viaja en Bus, with an inescapable commitment to customer satisfaction, and positioned in the medium term as one of the most popular e-commerce platforms for sale of land tickets.',
    about_document3: 'Our website and self-service totems are inclusive services, which complement the services of bus companies and favor bus passengers.',
    about_document4: 'Customer orientation: We focus on giving a close and professional attention that generates security and trust.',
    about_document5: 'Innovation: We will constantly work to find tools and alternatives that allow us to continuously improve our service.',
    privacy: 'Privacy policies',
    privacy_document1: 'These privacy policies govern the use that every natural or legal person that we will call “Client” gives to the platform and the security and treatment conditions that are given to the collected data.',
    privacy_document2: 'It establishes the conditions of collection, use and situation where said information is shared and the rights that the "Client" has over it, without making a difference if it has been used through a desktop or mobile web application.',
    privacy_document3: 'For the purposes of this Privacy Policy, the Client expresses his full acceptance of the clauses described herein, therefore, constitutes a valid and binding agreement between the Client and Viaja en Bus.',
    privacy_document4: 'In the event that the User does not accept the conditions or is not in full agreement with the Privacy Policy, he must stop using the Platform and refrain from downloading or using it directly or indirectly, and from using any service provided by it. It is also the Client\'s responsibility to periodically review the Platform\'s Privacy Policy and see its updates or modifications.',
